...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_OBJECT_NAME = 3,                /* OBJECT_NAME  */
  YYSYMBOL_VERTEX_NORMAL = 4,              /* VERTEX_NORMAL  */
  YYSYMBOL_VERTEX_TEXTURE = 5,             /* VERTEX_TEXTURE  */
  YYSYMBOL_VERTEX = 6,                     /* VERTEX  */
  YYSYMBOL_SHADING = 7,                    /* SHADING  */
  YYSYMBOL_USE_MATERIAL = 8,               /* USE_MATERIAL  */
  YYSYMBOL_MTL_NAME = 9,                   /* MTL_NAME  */
  YYSYMBOL_FACE = 10,                      /* FACE  */
  YYSYMBOL_SLASH = 11,                     /* SLASH  */
  YYSYMBOL_NUMBER = 12,                    /* NUMBER  */
  YYSYMBOL_MTL_PATH = 13,                  /* MTL_PATH  */
  YYSYMBOL_STRING = 14,                    /* STRING  */
  YYSYMBOL_INTEGER = 15,                   /* INTEGER  */
  YYSYMBOL_YYACCEPT = 16,                  /* $accept  */
  YYSYMBOL_input = 17,                     /* input  */
  YYSYMBOL_line = 18,                      /* line  */
  YYSYMBOL_vertices = 19,                  /* vertices  */
  YYSYMBOL_vertex = 20                     /* vertex  */
};
...
# endif
     ...
     && (! defined __cplusplus \
         || (defined OBJSTYPE_IS_TRIVIAL && OBJSTYPE_IS_TRIVIAL)))
...
{
  "\"end of file\"", "error", "\"invalid token\"", "OBJECT_NAME",
  "VERTEX_NORMAL", "VERTEX_TEXTURE", "VERTEX", "SHADING", "USE_MATERIAL",
  "MTL_NAME", "FACE", "SLASH", "NUMBER", "MTL_PATH", "STRING", "INTEGER",
  "$accept", "input", "line", "vertices", "vertex", YY_NULLPTR
};
...
{
      -3,    -6,    -1,     0,     2,    -5,     1,     3,     4,    17,
      -3,    -7,     6,     8,     9,    -7,    -7,    -7,    11,    -7,
       4,    -7,    -7,    12,    -7,    13,    -2,    -7,    -7,    -7,
      14,    15,    -7,    16,    -7
};
...
static const yytype_int8 yydefact[] =
{
       ...
       2,     7,     0,     0,     0,    10,     9,     8,    14,    11,
      12,     1,     3,     0,     6,     0,     0,    13,     5,     4,
       0,    15,    16,     0,    17
};
...
static const yytype_int8 yytable[] =
{
      ...
      15,    12,    13,    31,    14,    16,    17,    21,    23,    18,
      24,    25,    26,     0,    28,    29,    33,    27,    22,    32,
       0,    34
};

static const yytype_int8 yycheck[] =
{
       3,     4,     5,     6,     7,     8,     9,    10,    14,    11,
      15,    12,    12,    15,    12,    14,    13,     0,    12,    15,
      12,    12,    11,    -1,    12,    12,    11,    20,    10,    15,
      -1,    15
};
...
static const yytype_int8 yystos[] =
{
      ...
      18,    14,    12,    12,    12,    15,    14,    13,    15,    19,
      20,     0,    17,    12,    12,    12,    11,    19,    12,    12,
      11,    15,    15,    11,    15
};
...
#define yyclearin       (yychar = OBJEMPTY)
...
/* Backward compatibility with an undocumented macro.
   Use OBJerror or OBJUNDEF. */
#define YYERRCODE OBJUNDEF
...
yy_symbol_value_print (FILE *yyo,
                       yysymbol_kind_t yykind, YYSTYPE const * const yyvaluep, parserContext *context, yyscan_t scanner)
{
  FILE *yyoutput = yyo;
  YY_USE (yyoutput);
  YY_USE (context);
...
yy_reduce_print (yy_state_t *yyssp, YYSTYPE *yyvsp,
                 int yyrule, parserContext *context, yyscan_t scanner)
{
...
yydestruct (const char *yymsg,
            yysymbol_kind_t yykind, YYSTYPE *yyvaluep, parserContext *context, yyscan_t scanner)
{
  YY_USE (yyvaluep);
  YY_USE (context);
  YY_USE (scanner);
...
int
yyparse (parserContext *context, yyscan_t scanner)
{
...
#define YYPOPSTACK(N)   (yyvsp -= (N), yyssp -= (N))
  ...
  yychar = OBJEMPTY; /* Cause a token to be read.  */
...
yyreduce:
  ...
  switch (yyn)
    {
  case 4: /* line: VERTEX NUMBER NUMBER NUMBER  */
#line 49 "objParser.y"
    {
        vec3 vert = {
            (yyvsp[-2].f),
...
yyerrlab:
  ...
  yytoken = yychar == OBJEMPTY ? YYSYMBOL_YYEMPTY : YYTRANSLATE (yychar);
